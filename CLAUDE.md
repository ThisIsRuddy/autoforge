...
This command **requires** the project directory as an argument via `/var/www/git/autoforge`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/var/www/git/autoforge/.autoforge/prompts/app_spec.txt` and `/var/www/git/autoforge/.autoforge/prompts/initializer_prompt.md`

If `/var/www/git/autoforge` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/var/www/git/autoforge/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/var/www/git/autoforge/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/var/www/git/autoforge/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/var/www/git/autoforge/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/var/www/git/autoforge/.autoforge/prompts/`!
>
> **Files created:**
> - `/var/www/git/autoforge/.autoforge/prompts/app_spec.txt`
> - `/var/www/git/autoforge/.autoforge/prompts/initializer_prompt.md`
>
